...
```shell script
# Close lottery.
0 0,12 * * * cd ~/lotteries-dao-scheduler && yarn execute:close:mainnet

# Draw lottery.
3 0,12 * * * cd ~/lotteries-dao-scheduler && yarn execute:draw:mainnet

# Start lottery.
5 0,12 * * * cd ~/lotteries-dao-scheduler && yarn execute:start:mainnet
```
